...
class DoctorPanel(QWidget):
    ...
    def _build(self):
        ...
        self.doc_otp_e = mkinp("8-char OTP (e.g. X7K2P9QA)", mono=True)
...
class PatientPanel(QWidget):
    ...
    def _build(self):
        ...
        self.otp_e = mkinp("Enter 8-char OTP", mono=True); self.otp_e.setMaxLength(8)
